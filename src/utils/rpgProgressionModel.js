...
export const RPG_ATTRIBUTE_INFO = Object.freeze({
  STR: Object.freeze({
    ...
    summary: 'Carga, potência e evolução nos principais movimentos de força.',
    howToEarn: 'Confirme séries com carga em supinos, desenvolvimentos, leg press, remadas baixas e levantamentos terra. Exercícios sem uma categoria específica também contribuem para Força.',
  ...
  DEX: Object.freeze({
    ...
    summary: 'Controle, execução e qualidade técnica dos movimentos.',
    howToEarn: 'Confirme séries com carga em crossover, crucifixo inverso, stiff, afundos, serrote, face pull e remada curvada para acumular XP em Técnica.',
    calculation: `XP = volume confirmado × ${volumePercent}%. Quando a sessão inteira é classificada como sobrecarga, o ganho recebe +${overloadPercent}%. Missões contam somente no XP total.`,
  ...
  VIT: Object.freeze({
    ...
    summary: 'Capacidade de sustentar esforço em pernas, core e atividades cardiovasculares.',
    howToEarn: 'Confirme séries com carga em exercícios de pernas, core e atividades cardiovasculares para acumular XP em Resistência. Atividades sem volume de carga ainda não somam XP neste atributo.',
    calculation: `XP = volume confirmado × ${volumePercent}%. Quando a sessão inteira é classificada como sobrecarga, o ganho recebe +${overloadPercent}%. Missões contam somente no XP total.`,
  ...
  CHA: Object.freeze({
    ...
    summary: 'Desenvolvimento de grupos musculares ligados à composição estética.',
    howToEarn: 'Confirme séries com carga em elevações laterais e frontais, tríceps, roscas, encolhimentos e elevação pélvica para acumular XP em Estética.',
    calculation: `XP = volume confirmado × ${volumePercent}%. Quando a sessão inteira é classificada como sobrecarga, o ganho recebe +${overloadPercent}%. Missões contam somente no XP total.`,
  ...
  FOCUS: Object.freeze({
    short: 'FOCO',
    name: 'Foco',
    summary: 'Reflete sua constância recente e a manutenção da sequência.',
  ...
  DISCIPLINE: Object.freeze({
    short: 'DISCIPLINA',
    name: 'Disciplina',
    summary: 'Representa a frequência acumulada e a regularidade ao longo do tempo.',
