...
describe('modelo canônico do histórico', () => {
  it('preserva séries legadas válidas sem inventar conclusão para rascunhos explícitos', () => {
    const entry = normalizeHistoryEntry({
      workout_date: '2026-08-20T00:00:00.000Z',
      workout_name: 'A',
      total_volume: 1200,
      bonus_xp: 40,
      exercises: [{ name: 'Supino', done: true, sets: [
        { weight: '50', reps: '10' },
        { weight: '55', reps: '8', checked: true },
    ...
    expect(entry.exercises[0].sets.map((set) => set.completed)).toEqual([true, true, false, false]);
