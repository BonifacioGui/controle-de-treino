...
const REQUIRED_FEATURES = ['Boss', 'ExerciseCard', 'RestTimer', 'PR', 'Atributos e XP', 'Perfil e objetivos', 'Scanner biométrico', 'Guia de exercício', 'Confirmação de e-mail', 'Level Up', 'charts', 'modais', 'states', 'inputs'];
