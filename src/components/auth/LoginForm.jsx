...
const LoginForm = ({ onSwitch }) => {
  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-left duration-300">
      ...
      {/* CABEÇALHO LOGIN - Design Limpo e Simétrico */}
      <div className="flex flex-col items-center text-center mb-10 mt-2">
        <div className="flex items-center justify-center gap-3">
          <h1 className="font-sans font-black text-5xl sm:text-6xl tracking-[0.15em] bg-gradient-to-r from-[#00ffff] via-[#ff00ff] to-[#00ffff] bg-[length:200%_auto] animate-gradient bg-clip-text text-transparent leading-none uppercase drop-shadow-[0_0_10px_rgba(0,255,255,0.4)] hover:drop-shadow-[0_0_15px_rgba(255,0,255,0.6)] transition-all duration-500">
            SOLO
          </h1>
      ...
      {/* SEÇÃO DE INPUTS - Com Ícones e Design Tático */}
      <div className="space-y-5">
        
        {/* Campo E-mail */}
        <div className="group">
          <label className="text-[10px] font-black uppercase text-muted mb-1.5 block group-focus-within:text-primary transition-colors">E-mail de Acesso</label>
          {/* O container ganha a classe 'focus-within:' para o glow neon quando o usuário clica */}
          <div className="flex items-center w-full bg-input border-2 border-border rounded-xl px-4 py-4 focus-within:border-primary focus-within:shadow-[0_0_15px_rgba(0,243,255,0.15)] transition-all duration-300">
            {/* 🔥 O ícone Lucide 'User' é adicionado aqui */}
        ...
        <div className="relative group">
          <label className="text-[10px] font-black uppercase text-muted mb-1.5 block group-focus-within:text-primary transition-colors">Senha de Acesso</label>
          <div className="flex items-center w-full bg-input border-2 border-border rounded-xl px-4 py-4 focus-within:border-primary focus-within:shadow-[0_0_15px_rgba(0,243,255,0.15)] transition-all duration-300">
            {/* 🔥 O ícone Lucide 'Lock' é adicionado aqui */}
      ...
      {/* 🔥 O BOTÃO GRADIENTE ANIMADO DO DESIGN */}
      <button 
        onClick={handleLogin} 
