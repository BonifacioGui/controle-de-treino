...
const CyberNav = ({ currentView, setView }) => {
  ...
  return (
    <nav aria-label="Navegação principal" className="solo-bottom-nav fixed bottom-0 left-0 right-0 z-[100] border-t border-border bg-card/95 px-1 pb-[calc(0.65rem+env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl sm:px-6">
