      ...
      <div>
        <div className="grid grid-cols-4 gap-2">
          <div className="bg-input/50 dark:bg-input border border-border p-2 rounded-2xl text-center shadow-sm">
            ...
            <p className="text-[11px] text-muted font-black uppercase tracking-wide">Idade</p>
          ...
          <div className="bg-input/50 dark:bg-input border border-border p-2 rounded-2xl text-center shadow-sm">
            ...
            <p className="text-[11px] text-muted font-black uppercase tracking-wide">Peso</p>
          ...
          <div className="bg-input/50 dark:bg-input border border-border p-2 rounded-2xl text-center shadow-sm">
            ...
            <p className="text-[11px] text-muted font-black uppercase tracking-wide">BF</p>
          ...
          <div className="bg-input/50 dark:bg-input border border-border p-2 rounded-2xl text-center shadow-sm tooltip relative group">
            <Activity className="mx-auto text-secondary mb-1 opacity-50" size={14} />
            <p className="text-[11px] text-muted font-black uppercase tracking-wide" title="Relação Cintura-Quadril">RCQ</p>
            <p className="text-lg font-black text-primary">{rcq}</p>
          </div>
        </div>
        
        {/* Subtítulo de Diagnóstico */}
        <p className="text-center text-[11px] text-muted uppercase font-bold tracking-wide mt-3">
        ...
        <div className="bg-card border-2 border-border rounded-3xl p-4 shadow-sm flex items-center justify-between transition-colors">
          <div className="flex-1">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[11px] text-muted font-black uppercase tracking-wide leading-none">Massa Magra</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[11px] text-muted font-black uppercase tracking-wide leading-none">Gordura ({latestBio.bf}%)</p>
          ...
          <div className="w-28 h-28 shrink-0 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center flex-col">
              ...
              <span className="text-[11px] text-muted uppercase font-bold -mt-1">KG</span>
            </div>
          </div>
        </div>
      )}
